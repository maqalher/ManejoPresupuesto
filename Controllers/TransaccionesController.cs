...
public class TransaccionesController: Controller
{
    ...
    {   
        ...
        {
            var semana = i + 1;
            var fechaIncio = new DateTime(año, mes, diasSegmentados[i].First());
            ...
            {
                grupoSemana.FechaInicio = fechaIncio;
    ...
    {   
        ...
        var transaccionesAgrupadas = transaccionPorMes.GroupBy(x => x.Mes).Select(x => new ResultadoObtenerPorMes()
        {
            Mes = x.Key,
    ...
    public async Task<IActionResult> Editar(TransaccionActualizacionViewModel modelo)
    {
        ...
        await repositorioTransacciones.Actializar(transaccion, modelo.MontoAnterior, modelo.CuentaAnteriorId);
